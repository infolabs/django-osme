! function (e) {
    var t = function () {
        ...
        function l(e, t) {
            ...
            var r = e.regions,
                n = [],
                o = t.postFilter || (e.meta && e.meta.postFilter ? new Function("region", e.meta.postFilter) : 0),
                a = t.scheme || e.meta && e.meta.scheme,
                i = e.meta && e.meta.disputedBorders || {},
                s = t.recombine || t.lang || "en",
                u = "string" == typeof s ? i[s] : s,
                l = 0;
            for (var h in i) {
                var g = i[h];
                for (var d in g) {
                    var v = g[d];
                    "string" == typeof v && (g[d] = new Function("region", v))
                }
            }
            for (var h in r)
                if (r.hasOwnProperty(h) && (!o || o(p(h, e)))) {
                    if (u && u[+h]) l = c(e, {
                        filter: u[+h]
                    });
                    else if (a && a[+h]) {
                        var y = a[+h];
                        l = c(e, {
                            filter: "string" == typeof y ? new Function("region", y) : y
                        })
                    } else l = f(+h, e);
                    n[r[h].index] = {
                        type: "Feature",
                        ...
                        properties: {
                            osmId: h,
                            level: r[h].level,
                            properties: r[h].property || {},
                            parents: r[h].parents,
                            hintContent: r[h].name,
                            name: r[h].name,
                            title: r[h].name,
                            wikipedia: r[h].wikipedia,
                            orderIndex: r[h].index,
                            square: r[h].square
                        }
                    }
                } for (var m = [], b = (h = 0, n.length); h < b; ++h) n[h] && m.push(n[h]);
            return m
        }
        ...
        return {
            ...
            flipCoordinate: a,
            recombine: c,
            geoJSON: function (e, t, r, n) {
                n || (n = function (e) {
                    window.console && console.error(e)
                });
                var o = (t.lang || "en") + "_" + e;
                if (0 === (e + "").indexOf("http") ? o = e : (o = g + "?lang=" + o, t.quality && (o += "&q=" + (t.quality + 1)), t.type && (o += "&type=" + t.type)), !d[o] || t.nocache) {
                    var a = this;
                    this.loadData(o, function (e) {
                        d[o] = e, h(r, [a.parseData(e, t), e])
                    }, n)
                } else h(r, [this.parseData(d[o], t), d[o]])
            },
